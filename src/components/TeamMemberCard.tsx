...
export default function TeamMemberCard({ name, role, description, linkedin }: TeamMemberProps) {
    ...
    <div className="group flex flex-col h-full">
        ...
        <div className={`overflow-hidden transition-all duration-500 ease-in-out ${isOpen ? 'max-h-[500px] opacity-100' : 'max-h-0 opacity-0'}`}>
            <div className="pb-4 flex flex-col gap-4">
                ...
                <a href={linkedin} target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-2 text-[#0077b5] hover:text-[#005582] transition-colors w-fit">
