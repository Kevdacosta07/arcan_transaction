        ...
        <nav className="hidden md:flex items-center gap-12">
            <div className="flex items-center gap-8">
                ...
                <div className="relative group h-full flex items-center">
                    ...
                    {/* Dropdown Menu */}
                    <div className="absolute top-full left-1/2 -translate-x-1/2 pt-0 opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-300 min-w-[500px]">
                        <div className="bg-white p-8 shadow-[0_20px_50px_rgba(0,0,0,0.1)] border-t-2 border-[#021024] grid grid-cols-2 gap-12 relative mt-0">
                            {/* Triangle pointer */}
